...
class ProtossBot(sc2.BotAI):
    ...
    async def offensive_force_buildings(self):
        if self.units(PYLON).ready.exists:
            ...
            elif self.supply_used == 15 or self.supply_used == 19 or (self.supply_used == 36 and len(self.units(GATEWAY)) < 4)  or (len(self.units(WARPGATE)) < 6 and self.warpgate_done):
